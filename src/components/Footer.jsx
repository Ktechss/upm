        ...
        <div className="footer-section contact-info">
          ...
          <div className="contact-item">
            ...
            <span className="company-location">
              <span style={{fontWeight:'bold'}}> North America, Australia, London:</span>  +1 604 704 1157 
              <br/>
              <span style={{fontWeight:'bold'}}> Asia:</span>  +91-7696013691
              {/* +64 4 909 6000 <span style={{fontWeight:'bold'}}> Fax:</span> +64 4 380 9010 */}
              <br />
          ...
          <div className="contact-item">
            ...
            <span className="company-location">
              ...
              <br />
              <span style={{fontWeight:'bold'}}>Head Office: </span> Toronto, Ontario, Canada.
